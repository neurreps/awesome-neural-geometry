...
- [Symmetry and Geometry in Neural Representations](#symmetry-and-geometry-in-neural-representations)
  - [Contents](#contents)
- [Educational Resources](#educational-resources)
    - [Abstract Algebra + Group Theory](#abstract-algebra--group-theory)
      - [Textbooks & Notes](#textbooks--notes)
      - [Courses, Lectures, and Videos](#courses-lectures-and-videos)
    - [Differential Geometry + Lie Groups](#differential-geometry--lie-groups)
      - [Textbooks & Notes](#textbooks--notes-1)
      - [Courses, Lectures, and Videos](#courses-lectures-and-videos-1)
      - [Notebooks and Blogposts](#notebooks-and-blogposts)
    - [Information Geometry](#information-geometry)
      - [Primers](#primers)
    - [Topology](#topology)
      - [Courses, Lectures, and Videos](#courses-lectures-and-videos-2)
      - [Textbooks, Notes](#textbooks-notes)
    - [Geometric Machine Learning](#geometric-machine-learning)
      - [Textbooks](#textbooks)
      - [Courses, Lectures, and Videos](#courses-lectures-and-videos-3)
      - [Notebooks and Blogposts](#notebooks-and-blogposts-1)
    - [Computational Neuroscience](#computational-neuroscience)
      - [Textbooks](#textbooks-1)
      - [Books - General Audience](#books---general-audience)
      - [Courses, Lectures, and Videos](#courses-lectures-and-videos-4)
- [Datasets](#datasets)
    - [Open-Source Neuroscience Datasets](#open-source-neuroscience-datasets)
...
- [Research Papers](#research-papers)
    - [Neuroscience](#neuroscience)
      ...
      - [Methods](#methods)
    - [Geometric Machine Learning](#geometric-machine-learning-1)
      - [Theory](#theory)
      - [Estimation on Manifolds](#estimation-on-manifolds)
      - [Dimensionality Reduction and Disentangling](#dimensionality-reduction-and-disentangling)
      - [Deep Network Interpretability](#deep-network-interpretability)
      - [Group-Invariant Representation Learning](#group-invariant-representation-learning)
      - [Generalized Convolutional Neural Networks](#generalized-convolutional-neural-networks)
        - [Groups and Homogeneous Spaces](#groups-and-homogeneous-spaces)
        - [Geodesics and Riemannian Manifolds](#geodesics-and-riemannian-manifolds)
        - [Gauges and Bundles](#gauges-and-bundles)
